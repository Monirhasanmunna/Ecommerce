                                    ...
                                    <table id="datatable-fixed-header"
                                        ...
                                        <thead>
                                            <tr role="row">
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="datatable-fixed-header"
                                                    ...
                                                    style="width: 200px;">Created At</th>
                                                <th class="sorting" tabindex="0" aria-controls="datatable-fixed-header"
                                                    rowspan="1" colspan="1"
                                                    aria-label="Start date: activate to sort column ascending"
                                                    style="width: 200px;">Updated At</th>
                                                <th class="sorting" tabindex="0" aria-controls="datatable-fixed-header"
                                                     colspan="1"
                                        ...
                                        <tbody>
                                            ...
                                            <tr role="row" class="odd">
                                                ...
                                                <td><span><a style="color: white;" class="btn-sm bg-success" href="{{route('admin.subcategories.edit',[$subcategory->id])}}"><i class="fa fa-bars"></i></a> |

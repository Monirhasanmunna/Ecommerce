	...
	<div class="carousel-inner">
	  ...
	  <ul class="thumbnails">
		<li class="span3">
		  <div class="thumbnail">
		  <i class="tag"></i>
			<a href="{{route('product_details')}}"><img src="{{asset('themes/images/products/b1.jpg')}}" alt=""></a>
			<div class="caption">
			  <h5>Product name</h5>
			  <h4><a class="btn" href="{{route('product_details')}}">VIEW</a> <span class="pull-right">$222.00</span></h4>
			</div>
		  </div>
		</li>
		<li class="span3">
